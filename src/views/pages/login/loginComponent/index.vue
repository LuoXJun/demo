<template>
    <div class="login-component">
        <div class="header">
            ...
            <div class="des">输水隧洞多源检测数据信息融合及健康诊断平台</div>
        </div>
        <div class="userInfo">
                ...
                <el-form-item>
                    ...
                    >
                        <template #prefix>
                            ...
                            >
                                <path
                                    d="M19.1825 8.83041H17.4008C17.4008 5.96881 15.2137 3.78168 12.4261 3.78168C9.63471 3.78168 7.45147 5.96881 7.45147 8.83041H5.66589C5.66589 5.39571 8.69513 2 12.4222 2C16.1493 2 19.1825 5.39571 19.1825 8.83041ZM21.4437 11.7583C21.4437 10.7758 20.6445 9.97661 19.662 9.97661H5.38519C4.40274 9.97661 3.60352 10.7758 3.60352 11.7583V20.2183C3.60352 21.2008 4.40274 22 5.38519 22H19.6581C20.6406 22 21.4398 21.2008 21.4398 20.2183V11.7583H21.4437ZM13.9349 18.3743C13.9349 19.1111 13.3384 19.7115 12.5977 19.7115H12.4066C11.6698 19.7115 11.0694 19.115 11.0694 18.3743V14.7485C11.0694 14.0117 11.6659 13.4113 12.4066 13.4113H12.5977C13.3345 13.4113 13.9349 14.0078 13.9349 14.7485V18.3743Z"
                                    fill="#0266F0"
                                />
                            </svg>
                            <p class="line"></p>
